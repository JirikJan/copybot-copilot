            ...
            >
              <div className="p-5">
                <div className="flex justify-between items-start mb-3">
                  ...
                  {isClient && content.createdAt && (
                    <span className="text-xs text-muted-foreground">
                      {format(new Date(content.createdAt), "d. MMMM yyyy, HH:mm", { locale: cs })}
                    </span>
                  )}
                </div>
                ...
                >
                  <motion.div
                    initial={false}
                    animate={{ height: expandedContent === content.id ? "auto" : "100px" }}
              ...
              <div className="bg-slate-50 px-5 py-3 border-t border-border/10 flex justify-between items-center">
                ...
                <button className="text-xs text-rose-500 hover:text-rose-600 transition-colors flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 mr-1" viewBox="0 0 20 20" fill="currentColor">
